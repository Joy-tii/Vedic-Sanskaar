...
const features = [
  {
    name: 'दोस्तों को आमंत्रित करें और लाभ बढ़ाएं',
    description:
      'प्रत्येक दोस्त को आमंत्रित करने पर आपको पाँच सेकंड पहले विशेष सूचनाएं प्राप्त होंगी। यदि आप किसी विद्वान को आमंत्रित करते हैं तो यह दस सेकंड होती है।',
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
    name: 'संस्कार और पूजा संबंधित सूचनाएं',
    description:
      'जब भी कोई विशेष यज्ञ, पूजा या वैदिक संस्कार होते हैं, आपको तुरंत सूचना मिलती है ताकि आप ओजपूर्ण भागीदारी कर सकें।',
    icon: DeviceNotificationIcon,
    screen: StocksScreen,
  },
  {
    name: 'अपने अनुसार आस्था में निवेश करें',
    description:
      'हम आपके धार्मिक संस्कारों और पूजाओं को सुरक्षित और पारदर्शी तरीके से संभालते हैं। आप बिना किसी चिंता के अपने अनुकूल सेवाओं का चयन कर सकते हैं।',
