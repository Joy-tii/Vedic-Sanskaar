      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          ...
          <div className="relative -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6">
            ...
            >
              {[
                ['परिवार प्रोफाइल प्रणाली', logoForbes],
                ['पंचांग और ज्योतिष सेवाएँ', logoTechcrunch],
                ['यज्ञ, पूजा और संस्कार', logoWired],
                ['विद्वान ब्राह्मण मार्गदर्शन', logoCnn, 'hidden xl:block'],
                ['मठ, मंदिर, तीर्थ जानकारी', logoBbc],
                ['AI आधारित कुंडली', logoCbs],
                ['गौशाला व सामाजिक सेवाएं', logoFastCompany],
                ['सुरक्षित ऑनलाइन भुगतान', logoHuffpost, 'hidden xl:block'],
