      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            <div className="text-xs/6 text-[#834C13]">Vedic Sanskaar Trust</div>
            <div className="text-sm text-[#2D1F12]">$VST</div>
          ...
          <div className="mt-3 border-t border-[#C6A15A] pt-5">
            <div className="flex items-baseline gap-2">
              <div className="text-2xl tracking-tight text-[#2D1F12] tabular-nums">
                {activeValue.toFixed(2)}
              </div>
              <div className="text-sm text-[#2D1F12]">₹INR</div>
              {percentageChange && (
                <div
                  className={clsx(
                    'ml-auto text-sm tracking-tight tabular-nums',
                    percentageChange >= 0 ? 'text-[#F39A43]' : 'text-[#A57142]',
                  )}
                >
                  {`${
                    percentageChange >= 0 ? '+' : ''
            ...
            <div className="mt-6 flex gap-4 text-xs text-[#834C13]">
              <div>1D</div>
              <div>5D</div>
              <div className="font-semibold text-[#F39A43]">1M</div>
              <div>6M</div>
              <div>1Y</div>
              <div>5Y</div>
            </div>
            <div className="mt-3 rounded-lg bg-[#FDD2A1] ring-1 ring-[#834C13]/40 ring-inset">
              <Chart
                width={286}
                height={208}
                paddingX={16}
                ...
                stroke="#834C13"
                gradientStart="#F39A43"
                gradientEnd="#F39A43"
              />
            </div>
            <div className="mt-4 rounded-lg bg-[#834C13] px-4 py-2 text-center text-sm font-semibold text-[#FDD2A1] cursor-pointer">
              ट्रेड करें
            </div>
            <div className="mt-3 divide-y divide-[#C6A15A] text-sm">
              <div className="flex justify-between py-1">
                <div className="text-[#A57142]">उद्घाटन मूल्य</div>
                <div className="font-medium text-[#2D1F12]">6,387.55</div>
              </div>
              <div className="flex justify-between py-1">
                <div className="text-[#A57142]">समापन मूल्य</div>
                <div className="font-medium text-[#2D1F12]">6,487.09</div>
              </div>
              <div className="flex justify-between py-1">
                <div className="text-[#A57142]">न्यूनतम मूल्य</div>
                <div className="font-medium text-[#2D1F12]">6,322.01</div>
              </div>
            </div>
          </div>
        </div>
