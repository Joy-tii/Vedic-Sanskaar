...
function DeviceArrowIcon(props) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#F4B400" fillOpacity={0.3} /> {/* Warm Yellow */}
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
function DeviceCardsIcon(props) {
  ...
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      ...
      <rect x={9} y={6} width={14} height={4} rx={1} fill="#F4B400" />
  ...
  return (
    <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}>
      <path
        ...
        fill="#1E293B"
      />
      <circle cx={11} cy={14} r={2} fill="#F4B400" />
      <circle cx={11} cy={20} r={2} fill="#F4B400" />
      <circle cx={11} cy={26} r={2} fill="#F4B400" />
      <path
...
export function SecondaryFeatures() {
  return (
    <section
      ...
      className="py-20 sm:py-32 bg-[#FDF7F2]" // Soft Beige background
    >
      <Container>
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-3xl font-medium tracking-tight text-[#1E293B]">
            अब समय है अपने संस्कारों का पोर्टफोलियो बनाने का
          </h2>
          <p className="mt-2 text-lg text-[#1E293B]">
        ...
        >
          {features.map((feature) => (
            <li
              key={feature.name}
              className="rounded-2xl border border-[#F4B400] bg-[#FFFFFF] p-8"
            >
              <feature.icon className="h-8 w-8 text-[#F4B400]" />
              <h3 className="mt-6 font-semibold text-[#1E293B]">{feature.name}</h3>
              <p className="mt-2 text-[#64748B]">{feature.description}</p>
            </li>
          ))}
        </ul>
      </Container>
